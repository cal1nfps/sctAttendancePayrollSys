...
namespace SCTAttendanceSystemUI.Forms
{
    public partial class Webcam : Form
    {
        ...
        private void ApplyCircularMask(Button captureButton)
        {
        ...
        private void captureButton_Click(object sender, EventArgs e)
        {
            if (videoSource != null && videoSource.IsRunning)
            {
                ...
                EditButtonForm editForm = new EditButtonForm();
                ...
                editForm.city = city;
                editForm.postal = postal;
                editForm.phone = phone;
                editForm.telephone = telephone;
                editForm.email = email;
                editForm.empnum = empnum;
                editForm.hdate = hdate;
                editForm.occupation = occupation;
                editForm.department = department;
                editForm.jobstatus = jobstatus;
                editForm.timein = timein;
                editForm.timeout = timeout;

                // Display the captured image in Form2's PictureBox
                editForm.SetCapturedImage(capturedImage);
                editForm.Show();
